...
SOURCES: list[SourceConfig] = [
    {
        "key": "gs_yjspy_zytz",
        "name": "研究生院-研究生培养重要通知",
        "url": "https://gs.dlut.edu.cn/yjspy/pygcguan_li/zytz.htm",
        "selector": ".list li a[href]",
        "parser": parse_text_content,
        "category": "graduate",
        "base_url": "https://gs.dlut.edu.cn/",
    },
    {
        "key": "campus_jxyxbzzx",
        "name": "开发区校区教学运行保障中心",
    ...
    },
    {
        "key": "teach_jxwj",
        "name": "教务处教学文件",
        "url": "https://teach.dlut.edu.cn/jiaoxuewenjian/list.jsp?urltype=tree.TreeTempUrl&wbtreeid=1082",
        "selector": ".list a[href*='wbnewsid=']",
        "parser": parse_title_attr,
        "category": "teaching",
        "base_url": "https://teach.dlut.edu.cn/",
